...
export default function LatexPreview({ content, className = '' }: LatexPreviewProps) {
 ...
 if (!content.trim()) {
 return (
 <div className={`text-secondary/80 italic text-sm ${className}`}>
 ...
 className={`text-primary leading-relaxed text-sm whitespace-pre-wrap ${className} [&_.katex-display]:my-2 [&_.katex-display]:py-0`}
 />
 )
}
