    ...
    <footer className="bg-gray-50 dark:bg-slate-900 border-t border-gray-100 dark:border-slate-800">
      <div className="max-w-7xl mx-auto px-6 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          ...
          {/* Links */}
          <div>
            <h4 className="text-sm font-bold text-gray-900 dark:text-white uppercase tracking-wider mb-6">Khám phá</h4>
          ...
          {/* Contact */}
          <div>
            <h4 className="text-sm font-bold text-gray-900 dark:text-white uppercase tracking-wider mb-6">Liên hệ</h4>
        ...
        <div className="pt-8 border-t border-gray-100 dark:border-slate-800 flex flex-col md:row justify-between items-center gap-4">
