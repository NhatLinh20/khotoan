  ...
  return (
    <div className="flex flex-col gap-4 max-w-7xl mx-auto pb-10">
      ...
      <div className="flex items-center justify-between">
        <div>
          <p className="text-[10px] font-black text-primary uppercase tracking-widest mb-0.5">Hệ thống quản lý</p>
        ...
        <Link
          ...
          className="flex items-center gap-2 bg-primary text-white px-5 py-2.5 rounded-xl font-black hover:bg-primary-dark transition-all hover:scale-105 shadow-lg shadow-primary/20 text-xs"
        >
