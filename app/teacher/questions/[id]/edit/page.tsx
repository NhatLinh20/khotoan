  ...
  return (
    <div className="flex flex-col gap-8">
      ...
      <div>
        ...
        <p className="text-xs font-black text-primary uppercase tracking-widest mb-1">Chỉnh sửa</p>
        <h1 className="text-3xl font-black text-gray-900 dark:text-white">
          Sửa câu hỏi{' '}
          <code className="text-primary bg-primary/10 px-3 py-1 rounded-xl text-2xl">
            {q.question_code}
          </code>
        </h1>
