          ...
          <div className="overflow-x-auto rounded-2xl border border-gray-100 dark:border-slate-800 shadow-sm">
            <table className="w-full text-sm">
              <thead>
                <tr className="bg-gray-50 dark:bg-slate-800/60">
                  <th className="px-5 py-3.5 text-left font-bold text-gray-600 dark:text-gray-400 text-xs uppercase tracking-wider">Học viên</th>
                  <th className="px-5 py-3.5 text-left font-bold text-gray-600 dark:text-gray-400 text-xs uppercase tracking-wider">Địa chỉ IP / Vị trí</th>
                  <th className="px-5 py-3.5 text-left font-bold text-gray-600 dark:text-gray-400 text-xs uppercase tracking-wider">Trạng thái</th>
                  <th className="px-5 py-3.5 text-left font-bold text-gray-600 dark:text-gray-400 text-xs uppercase tracking-wider">Thiết bị</th>
                  <th className="px-5 py-3.5 text-left font-bold text-gray-600 dark:text-gray-400 text-xs uppercase tracking-wider">Thời gian</th>
                </tr>
              </thead>
              <tbody className="divide-y divide-gray-100 dark:divide-slate-800">
                {currentLogs.map((log) => (
                    ...
                    <td className="px-5 py-4">
                      {log.is_suspicious ? (
                        <div className="flex flex-col gap-1 max-w-[200px]">
                          <span className="inline-flex items-center gap-1 px-2.5 py-1 rounded-md text-xs font-bold bg-red-100 text-red-700 dark:bg-red-900/30 dark:text-red-400 w-fit">
                            <AlertTriangle size={12} /> Bất thường
                          </span>
                          <span className="text-xs text-red-600/80 dark:text-red-400/80 line-clamp-2" title={log.suspicious_reason || ''}>
                            {log.suspicious_reason}
                          </span>
                        </div>
                      ) : (
                        <span className="inline-flex items-center gap-1 px-2.5 py-1 rounded-md text-xs font-bold bg-green-100 text-green-700 dark:bg-green-900/30 dark:text-green-400 w-fit">
                          <Check size={12} /> Bình thường
                        </span>
                      )}
                    </td>
                    <td className="px-5 py-4">
                      <div className="flex items-center gap-1.5 text-gray-500 dark:text-gray-400 max-w-[150px]">
