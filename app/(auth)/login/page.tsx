		...
		<div className="animate-in fade-in slide-in-from-bottom-4 duration-700 font-body">
			...
			<div className="mb-6">
				<button
					...
					className="w-full flex items-center justify-center gap-3 px-6 py-4 border-2 border-secondary/20 rounded-md text-primary bg-surface hover:bg-neutral hover:border-secondary/40 active:scale-[0.98] transition-all shadow-sm font-bold text-[0.95rem]"
				>
			...
			<div className="relative flex items-center mb-6">
				...
				<span className="flex-shrink mx-4 text-secondary/50 text-[0.78rem] font-bold uppercase tracking-[0.14em] font-display">Hoặc đăng nhập bằng email</span>
				<div className="flex-grow border-t border-secondary/20"></div>
			</div>
