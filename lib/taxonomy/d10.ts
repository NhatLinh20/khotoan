...
export const D10: ChapterItem[] = [
  ...
  { value: 6, label: 'Chương 6. Thống kê', lessons: [
  ...
  { value: 7, label: 'Chương 7. Bất phương trình bậc 2 một ẩn', lessons: [
  ...
  { value: 8, label: 'Chương 8. Đại số tổ hợp', lessons: [
  ...
  { value: 10, label: 'Chương 10. Xác suất', lessons: [
